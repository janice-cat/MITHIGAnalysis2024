...
int main(int argc, char *argv[])
{
  ...
  string sideBand        = CL.Get      ("sideBand", "SBP");               // sideBand (string): whether subtraction is from plus or minus side: SBP, SBM
  double sideBandEdge    = CL.GetDouble("sideBandEdge", 3);               // sideBandEdge (float): number of standard deviations from mass peak to the start of the side band region
  string output          = CL.Get      ("Output", "DCA.root");            // Output file
